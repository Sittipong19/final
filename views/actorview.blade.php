...
<html lang="en">
  ...
  <a href="addactor" class="btn btn-info">add</a>
            ...
            <table>
                <tr align="center">
                    ...
                    <td style="padding:30px;">นามสกุล</td>
                    <td style="padding:30px;">เพศ</td>
                ...
                <tr align="center">
                    ...
                    <td><a href="{{url('/deleteactor',$data->id)}}" class="btn btn-danger">ลบ</a></td>
